			...
			<tbody>
				...
				<tr>
					...
					<td class="text-center">
						...
						<!-- <button id='edit'> -->
						<!-- <a href="<?php echo site_url('admin/stockbarang/update_barang/'.$row->id);?>">Edit</a> -->
							<!-- </button> -->
						<!-- <br/>
						<a href="<?php echo site_url('kulina/delete/'.$row->id);?>">
						<img src="<?php echo base_url(); ?>assets/images/img/delete1.png" alt='delete' height='15px'> -->
						</a>
					</td>
				</tr>
				<?php } ?>
